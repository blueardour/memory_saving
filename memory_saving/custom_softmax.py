...
class softmax(torch.autograd.Function):
    ...
    def forward(ctx, x, dim, training=False, \
        ...
        x = custom_quant.Quant.forward(ctx, x, training, fp_forward1, clip_val1, level1, non_negative_only1, iteration1, ema_decay1, groups1, stochastic_round1, '_1')
        y = F.softmax(x, dim)
        y = custom_quant.Quant.forward(ctx, y, training, fp_forward2, clip_val2, level2, non_negative_only2, iteration2, ema_decay2, groups2, stochastic_round2, '_2')
        ctx.dim = dim
        return y
    ...
    def backward(ctx, grad_output):
        ...
        return grad_input, None, None, None, grad_clip1, None, None, None, None, None, None, None, grad_clip2, None, None, None, None, None, None
