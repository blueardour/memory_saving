...
class matmul(torch.autograd.Function):
    ...
    def forward(ctx, input1, input2, training=True, \
        ...
        custom_quant.Quant.forward(ctx, input1, training, fp_forward1, clip_val1, level1, non_negative_only1, iteration1, ema_decay1, groups1, stochastic_round1, shift1, '_1')
        ...
        custom_quant.Quant.forward(ctx, input2, training, fp_forward2, clip_val2, level2, non_negative_only2, iteration2, ema_decay2, groups2, stochastic_round2, shift2, '_2')
